...
public class ScratcherViewDraw extends SurfaceView implements Animation.AnimationListener{
    ...
    private ScratcherViewDraw scratcherView;
    private Bitmap mBitmap;
    private EPSApplication application;
    private Bitmap newDest;

    public ScratcherViewDraw(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //Bitmap resizedBitmap = Bitmap.createScaledBitmap(getEpsApplication().drawBitmap,  scratcherView.getWidth(), scratcherView.getHeight(), false);
        Bitmap resizedBitmap  = Bitmap.createScaledBitmap(getEpsApplication().scratchImage,  scratcherView.getWidth(), scratcherView.getHeight(), false);
    ...
    protected void onDraw(Canvas canvas){
        ...
        Bitmap scaledloadedBitmap = Bitmap.createScaledBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.find9_numbers_scratch),  scratcherView.getWidth(), scratcherView.getHeight(), false);
