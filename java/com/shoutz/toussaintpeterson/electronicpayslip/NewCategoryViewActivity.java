 ...
 */
public class NewCategoryViewActivity extends AbstractEPSActivity implements AdapterView.OnItemSelectedListener{
    ...
    @Bind(R.id.app) LinearLayout app;
    ...
    public void onBackPressed(){
        //EditText searchField = (EditText)findViewById(R.id.search_field);
            ...
            else if(quickSearchIcon2.getVisibility() == View.VISIBLE && quickSearchField != null){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*if(categoryName.equalsIgnoreCase("Search")){
            ...
            setContentView(R.layout.new_category_view);
...
//            }
            ...
            cartImage.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View view) {
                    if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(NewCategoryViewActivity.this, cartImage, "reveal");
                        Intent intent = new Intent(NewCategoryViewActivity.this, ShoppingListViewActivity.class);
                        intent.putExtra("category", categoryName);
                        intent.putParcelableArrayListExtra("games", tempGames);
                        startActivity(intent, options.toBundle());
                    }
                    else{
                        Intent i = new Intent(NewCategoryViewActivity.this, ShoppingListViewActivity.class);
        ...
        /*if(isSearch){
            ...
            //ATTN!!!!!! uncomment if going back to regular view
                ...
                ExpandableListAdapter listAdapter = new ExpandableListAdapter(NewCategoryViewActivity.this, listDataHeader, listDataChild);
...
//                } else {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
            ...
            public void onClick(View v) {
                if(!isSearch) {
                    ...
                    dynamicSetBack(tempGames.get(getPosition()).getBackURL());
                    dynamicSetIcon(tempGames.get(getPosition()).getLogoURL());

                }
                else{
                    Intent i = new Intent(NewCategoryViewActivity.this, GameViewActivity.class);
                    i.putExtra("category", categoryName);
                    i.putParcelableArrayListExtra("games", tempGames);
    ...
    private void dynamicSetIcon(String url){
    ...
    private void dynamicSetBack(String url){
        ...
        Glide.with(getApplicationContext())
                ...
                .listener(new RequestListener<String, GlideDrawable>() {
                    ...
                    public boolean onResourceReady(GlideDrawable resource, String model, Target<GlideDrawable> target, boolean isFromMemoryCache, boolean isFirstResource) {
                        ...
                        //app.animate().translationX(-345);
                        //app.animate().scaleX(.55f).setInterpolator(new AccelerateDecelerateInterpolator()).setDuration(1000);

                        //ObjectAnimator anim = ObjectAnimator.ofFloat(app, "translationX", -drawer.getWidth());
                        //ObjectAnimator anim2 = ObjectAnimator.ofFloat(drawer, "translationX", -drawer.getWidth());
                        ...
                        set.addListener(new Animator.AnimatorListener() {
                            ...
                            public void onAnimationEnd(Animator animator) {
                                LinearLayout app = (LinearLayout)findViewById(R.id.app);
                                app.animate().scaleX(.5f).setInterpolator(new AccelerateDecelerateInterpolator()).setDuration(1000);
                            }
